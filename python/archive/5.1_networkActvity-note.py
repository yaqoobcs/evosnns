...
def plot(x,fname):
    ...
    #skipVal=0  
    #clockVal=350
    fig, ( ax6, ax7, ax8, ax9, ax10, ax11, ax12, ax13) = plt.subplots(8, 1, sharex=False, sharey=False, figsize=(gWidth, 7))
...
#    fig.text(.5, -0.1, 'txt', ha='center')
    ...
    # ax5.plot(clock,E, 'k-')
    # ax5.set_ylabel('input', rotation=0, fontsize=fSize, labelpad=padVal)
    ...
    lwid=3
    siz = 7
    ax6.plot(clock,A, 'k.', linewidth=lwid, markersize=siz)
    ax6.plot(clock,B, 'k.', linewidth=lwid, markersize=siz)
    ax6.plot(clock,C, 'k.', linewidth=lwid, markersize=siz)
    ax6.plot(clock,D, 'k.',  linewidth=lwid, markersize=siz)
    ax6.plot(clock,E, 'k.', linewidth=lwid, markersize=siz)
    ax6.plot(clock,F, 'k.', linewidth=lwid, markersize=siz)
    
    ax6.set_ylabel('Input', rotation=0, fontsize=fSize, labelpad=padVal)
    ax6.spines['top'].set_visible(False)
    ax6.spines['right'].set_visible(False)
    ax6.spines['left'].set_visible(False)
    #ax6.spines['bottom'].set_visible(False)
    ax6.get_yaxis().set_ticks([])
    ax6.get_xaxis().set_ticks(np.arange(0, len(clock)+1, 100))    
    ...
    ax10.set_ylabel('N2', rotation=0, fontsize=fSize, labelpad=padVal)
    ...
    ax11.set_ylabel('N1', rotation=0, fontsize=fSize, labelpad=padVal)
    ...
    ax12.set_ylabel('N0', rotation=0, fontsize=fSize, labelpad=padVal)
    ...
    ax13.get_yaxis().set_ticks([])
    ax13.set_xticks(np.arange(0, len(clock)+1, 100))
